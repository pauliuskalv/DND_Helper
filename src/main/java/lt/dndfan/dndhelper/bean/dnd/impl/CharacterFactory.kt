...
class CharacterFactory : ICharacterFactory {
    ...
    override fun createPlayableCharacter(allStats: List<Stat>, level: Int, armorClass: Int, initiative: Int, speed: Int, swimmingSpeed: Int, flyingSpeed: Int, alignment: EAlignment, hitDiceCount: Int, currentHitDice: Int, name: String, description: String, traits: List<ITrait>, abilities: List<IAbility>, spellModifier: Stat, temporaryHitPoints: Int, maxHitPoints: Int, currentHitPoints: Int, characterClass: String, characterSubclass: String, race: String, subrace: String, characterInventory: ICharacterInventory, inspiration: Boolean, inspirationDie: Int): IPlayableCharacter {
        return PlayableCharacter(allStats, level, armorClass, initiative,
                speed, swimmingSpeed, flyingSpeed,
                alignment, hitDiceCount, currentHitDice,
                name, description, traits, abilities, spellModifier,
